...
namespace WolvesAndRabbitsSimulation
{
    public partial class Form1 : Form
    {
        ...
        private Forest world = new Forest();
        ...
        {
            for (int x = 0; x < world.Width; x += Forest.PATCH_SIZE)
            {
                for (int y = 0; y < world.Height; y += Forest.PATCH_SIZE)
                {
                    world.SetGrassAt(new Point(x, y), world.Random(0, 50));
                }
            }
        }
